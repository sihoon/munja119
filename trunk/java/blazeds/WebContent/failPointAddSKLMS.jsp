...
<%
	...
	try {
		...
		sql.append("SELECT ETC_CHAR_2 as TR_ETC2, COUNT(*) as CNT FROM TBL_MSG_HIST WHERE RESERVED_DTTM like ? AND rslt_val != '1000' and used_cd='10' and ETC_CHAR_2!='2jaegyoon' GROUP BY ETC_CHAR_2");
