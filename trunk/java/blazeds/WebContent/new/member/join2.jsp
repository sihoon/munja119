...
<div id="joinBox">
	...
	<div class="juminBox">
		...
		<input type="text" name="jumin1" value="" style="width:100px;" /> - 
		<input type="text" name="jumin2" value="" style="width:100px;" />
...
현재, 타인의 주민번호를 도용하여 온라인 회원가입을 하신 이용자분들은 지금 즉시 명의도용을 중단하십시요.! </pre>
	...
	<div class="confirmBox">
		<img src="images/btn_next.gif" onclick="window.location.href='?content=join3'" />&nbsp;&nbsp;&nbsp;
