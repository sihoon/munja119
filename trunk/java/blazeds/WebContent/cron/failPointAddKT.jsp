...
<%
	...
	try {
		...
		sql.append("select C.RESERVED2 as TR_ETC2, count(*) as CNT from (select A.RESERVED2 from SDK_SMS_REPORT A inner join SDK_SMS_REPORT_DETAIL B on(A.JOB_ID = B.JOB_ID) where A.SEND_DATE like ? and B.RESULT  != 2 union all select RESERVED2 from SDK_SMS_SEND where SEND_DATE like ? and SEND_RESULT  in ('98','99') ) C  GROUP BY C.RESERVED2");
