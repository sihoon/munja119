...
<%
	...
	try {
		...
		sql.append("select C.USER_ID as TR_ETC2, count(*) as CNT from (select A.USER_ID from SDK_MMS_REPORT A inner join SDK_MMS_REPORT_DETAIL B on(A.JOB_ID = B.JOB_ID) where A.SEND_DATE like ? and B.RESULT  != 2 union all select USER_ID from SDK_MMS_SEND where SEND_DATE like ? and SEND_RESULT  in ('98','99') ) C  GROUP BY C.USER_ID");
