...
<%
	...
	try {
		...
		sql.append("SELECT sms_etc2, COUNT(*) as CNT FROM sms_log WHERE sms_senddate like ? AND TRIM(sms_rsltstat) != '6' GROUP BY sms_etc2");
		...
		if (count > 0) {
			...
			for (int i = 0; i < count; i++) {
				...
				mvo.setUser_id(SLibrary.IfNull(hm, "sms_etc2"));
