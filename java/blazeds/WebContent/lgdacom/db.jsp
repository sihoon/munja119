<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR" import="java.sql.* , com.common.*, com.common.properties.*, com.m.member.*"%>
...
com.m.member.UserInformationVO uvo = null;
