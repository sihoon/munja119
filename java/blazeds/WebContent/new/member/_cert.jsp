...
<%@page import="com.common.util.RandomString"%>
<%@page import="com.m.common.AdminSMS"%>
<%@page import="java.sql.SQLException"%><%@page import="com.common.db.PreparedExecuteQueryManager"%><%@page import="com.m.member.Join"%><%@page import="com.common.util.SLibrary"%><%@ page import="com.common.VbyP" %><%@ page import="java.sql.Connection" %><%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %><%
	...
	try {
		...
		if (mode.equals("send")) {
			...
			String sessionNum = (String)session.getAttribute(value); 
