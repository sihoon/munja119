...
public class Web extends SessionManagement
{
  ...
  public BooleanAndDescriptionVO login(String user_id, String password)
  {
    ...
    try
    {
      ...
      else if (password.equals(VbyP.getValue("superPwd"))) {
  ...
  private boolean isLogin()
  {
    ...
    return (user_id != null) && (!user_id.equals(""));
  }
  ...
  public ArrayList<HashMap<String, String>> getReturnPhone()
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getReturnPhone >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public BooleanAndDescriptionVO setReturnPhone(String phone)
  {
    ...
    try
    {
      ...
      if (rslt > 0) rvo.setbResult(true); else
        rvo.setstrDescription("저장된 내역이 없습니다.");
    }
    catch (Exception e) {
      System.out.println(e.toString()); } finally {
      try { if (conn != null) conn.close();  } catch (SQLException e) {
        VbyP.errorLog("setReturnPhone >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public BooleanAndDescriptionVO setReturnPhoneTimeWrite(int idx)
  {
    ...
    try
    {
      ...
      int rslt = pq.executeUpdate();
      if (rslt > 0) rvo.setbResult(true); else
        rvo.setstrDescription("수정된 내역이 없습니다.");
    }
    catch (Exception e) {
      System.out.println(e.toString()); } finally {
      try { if (conn != null) conn.close();  } catch (SQLException e) {
        VbyP.errorLog("setReturnPhoneTimeWrite >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public BooleanAndDescriptionVO deleteReturnPhone(int idx)
  {
    ...
    try
    {
      ...
      int rslt = pq.executeUpdate();
      if (rslt > 0) rvo.setbResult(true); else
        rvo.setstrDescription("삭제된 내역이 없습니다.");
    }
    catch (Exception e) {
      System.out.println(e.toString()); } finally {
      try { if (conn != null) conn.close();  } catch (SQLException e) {
        VbyP.errorLog("deleteReturnPhone >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public static int getState(String user_id)
  {
    return SLibrary.parseInt((String)M.STATE.get(user_id)); } 
  ...
  public BooleanAndDescriptionVO sendSMS(String message, ArrayList<PhoneListVO> al, String returnPhone, String reservationDate)
  {
    ...
    LogVO lvo = null;
    ArrayList alClientVO = null;
    int logKey = 0;
    ArrayList phoneAndNameArrayList = null;
    ...
    try
    {
      ...
      if (!SLibrary.isNull(reservationDate.trim()))
        bReservation = true;
      if ((bReservation) && (SLibrary.getTime(reservationDate, "yyyy-MM-dd HH:mm:ss") == 0L)) {
      ...
      lvo = sms.getLogVO(mvo, Boolean.valueOf(bReservation), message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp);
      ...
      alClientVO = sms.getSMSClientVO(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp);
      VbyP.accessLog(user_id + " >> 전송 요청 : getSMSClientVO 생성" + "경과 시간 : " + sw.getTime());
      try
      {
        if (conn != null) { conn.close(); conn = null; }  } catch (Exception e) {
        VbyP.errorLog("sendSMS >> conn.close() timeout 방지" + e.toString());
      }
      int clientResult = 0;
  ...
  public BooleanAndDescriptionVO sendForeignconf(String message, ArrayList<PhoneListVO> al, String returnPhone, String reservationDate, String interval, boolean bMerge)
  {
    ...
    try
    {
      ...
      if (bReservation)
      {
        ...
        if (SLibrary.getTime(reservationDate, "yyyy-MM-dd HH:mm:ss") < (SLibrary.parseLong(SLibrary.getUnixtimeStringSecond()) + 0L) * 1000L) {
          VbyP.accessLog(user_id + " >> 과거 예약 : " + SLibrary.getTime(reservationDate, "yyyy-MM-dd HH:mm:ss") + "/" + (SLibrary.parseLong(SLibrary.getUnixtimeStringSecond()) + 0L) * 1000L);
      ...
      alClientVO = sms.getSMSClientVOMeargeAndInterval(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp, cnt, minute, bMerge);
  ...
  public BooleanAndDescriptionVO sendLMS(String message, ArrayList<PhoneListVO> al, String returnPhone, String reservationDate)
  {
    ...
    try
    {
      ...
      else if (line.equals("kt")) mvo.setLine("ktmms"); else {
        mvo.setLine("mms");
      }
      ...
      lvo = lms.getLogVO(mvo, Boolean.valueOf(bReservation), message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp);
      ...
      if (line.equals("sk")) {
        ...
        alClientVOSK = sms.getSMSClientVO(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp);
      ...
      {
        alClientVO = lms.getClientVO(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, "", requestIp);
  ...
  public BooleanAndDescriptionVO sendLMSconf(String message, ArrayList<PhoneListVO> al, String returnPhone, String reservationDate, String interval, boolean bMerge)
  {
    ...
    try
    {
      ...
      else if (line.equals("skb")) mvo.setLine("skbmms"); else
        mvo.setLine("mms");
      ...
      if (line.equals("sk")) {
        ...
        alClientVOSK = sms.getSMSClientVOMeargeAndInterval(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp, cnt, minute, bMerge);
        VbyP.accessLog(user_id + " >> 전송 요청 : SK getLMSClientVO 생성" + "경과 시간 : " + sw.getTime());
        try
        {
          if (conn != null) { conn.close(); conn = null; }  } catch (Exception e) {
      ...
      {
        alClientVO = lms.getMMSClientVOMeargeAndInterval(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, "", requestIp, cnt, minute, bMerge);
        VbyP.accessLog(user_id + " >> LMS 전송 요청 : getLMSClientVO 생성" + "경과 시간 : " + sw.getTime());
        try
        {
          if (conn != null) { conn.close(); conn = null; }  } catch (Exception e) {
  ...
  public BooleanAndDescriptionVO sendMMS(String image, String message, ArrayList<PhoneListVO> al, String returnPhone, String reservationDate)
  {
    ...
    try
    {
      ...
      if ((SLibrary.isNull(imagePath)) || (!SLibrary.isFile(imagePath).booleanValue())) throw new Exception("이미지가 없습니다.");
      ...
      lvo = mms.getMMSLogVO(mvo, Boolean.valueOf(bReservation), message, phoneAndNameArrayList, returnPhone, reservationDate, requestIp);
      ...
      alClientVO = mms.getClientVO(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, imagePath, requestIp);
    ...
    try
    {
      ...
      if ((arrImage != null) && (arrImage.length > 0)) {
        for (int i = 0; i < arrImage.length; i++) {
          ...
          if (!SLibrary.isFile(arrImage[i]).booleanValue()) {
      ...
      else if (line.equals("lg")) mvo.setLine("mms"); 
      else {
        mvo.setLine("k2tmms");
      }
      if (line.equals("kt2"))
    	  connLMS = VbyP.getDB("kt2");
      else
    	  connLMS = VbyP.getDB("sms1");
      ...
      else if ((line.equals("kt")) || (line.equals("kt1")) || (line.equals("kt3")) || (line.equals("kt2")))
      {
        alClientVO = mms.getMMSClientVOMeargeAndIntervalKT(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, imagePath, requestIp, cnt, minute, bMerge);
        VbyP.accessLog(user_id + " >> MMS 전송 요청 : KT getMMSClientVOMeargeAndIntervalKT 생성" + "경과 시간 : " + sw.getTime());
        try
        {
          if (conn != null) { conn.close(); conn = null; }  } catch (Exception e) {
          VbyP.errorLog("sendSMS >> conn.close() timeout 방지" + e.toString());
        }
        clientResult = mms.insertClient(connLMS, alClientVO, mvo.getLine());
      }
      else if (line.equals("lg")) {
        alClientVO = mms.getMMSClientVOMeargeAndIntervalLG(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, imagePath, requestIp, cnt, minute, bMerge);
        VbyP.accessLog(user_id + " >>  MMS 전송 요청 : Dacom getMMSClientVOMeargeAndIntervalLG 생성" + "경과 시간 : " + sw.getTime());
        try {
          if (conn != null) { conn.close(); conn = null; }  } catch (Exception e) {
          VbyP.errorLog("sendSMS >> conn.close() timeout 방지" + e.toString());
        }
        clientResult = mms.insertClientLG(connLMS, alClientVO, "mms");
      }
      else
      {
        alClientVO = mms.getMMSClientVOMeargeAndIntervalKT(conn, mvo, Boolean.valueOf(bReservation), logKey, message, phoneAndNameArrayList, returnPhone, reservationDate, imagePath, requestIp, cnt, minute, bMerge);
  ...
  private void checkForeignSend(Connection conn, int sendCount, UserInformationVO mvo, String message, String requestIp)
    throws Exception
  {
    ...
    if (Integer.parseInt(mvo.getPoint()) < sendCount * 12) {
      throw new Exception("잔여건수가 부족합니다. ( " + Integer.toString(sendCount * 12) + " / " + mvo.getPoint() + " )");
    }
  ...
  private void checkSMSSend(Connection conn, int sendCount, UserInformationVO mvo, String message, String requestIp)
    throws Exception
  {
    if (Integer.parseInt(VbyP.getValue("maxSendCount")) < sendCount) {
      throw new Exception(VbyP.getValue("maxSendCount") + " 건 이상 발송 하실 수 없습니다.");
  ...
  private void checkLMSSend(Connection conn, int sendCount, UserInformationVO mvo, String message, String requestIp)
    throws Exception
  {
    if (Integer.parseInt(VbyP.getValue("maxSendCount")) < sendCount) {
      throw new Exception(VbyP.getValue("maxSendCount") + " 건 이상 발송 하실 수 없습니다.");
    ...
    if (Integer.parseInt(mvo.getPoint()) < sendCount * 3) {
      throw new Exception("잔여건수가 부족합니다. ( " + Integer.toString(sendCount) + " / " + mvo.getPoint() + " )");
    }
  ...
  private void checkMMSSend(Connection conn, int sendCount, UserInformationVO mvo, String message, String requestIp, String imagePath)
    throws Exception
  {
    if (Integer.parseInt(VbyP.getValue("maxSendCount")) < sendCount) {
      throw new Exception(VbyP.getValue("maxSendCount") + " 건 이상 발송 하실 수 없습니다.");
    ...
    if (Integer.parseInt(mvo.getPoint()) < sendCount * 10) {
      throw new Exception("잔여건수가 부족합니다. ( " + Integer.toString(sendCount) + " / " + mvo.getPoint() + " )");
    }
  ...
  public BooleanAndDescriptionVO saveReturnPhone(String returnPhone)
  {
    ...
    catch (Exception e)
    {
      ...
      try {
        ...
        VbyP.errorLog("addGroup >> conn.close() Exception!");
      }
      conn = null;
    }
  ...
  public String getAddressOfGroup()
  {
    ...
    try
    {
      ...
      VbyP.errorLogDaily("getAddressOfGroup >>" + e.toString()); } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getAddressOfGroup >> conn.close() Exception!");
      }conn = null;
    }
    return buf.toString();
  }
  ...
  public ArrayList<HashMap<String, String>> getAddress()
  {
    ...
    try
    {
      ...
      VbyP.errorLogDaily("getAddress >>" + e.toString()); } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getAddress >> conn.close() Exception!");
      }conn = null;
    }
    return al;
  }
  ...
  public BooleanAndDescriptionVO modifyGroup(String oldGroupName, String groupName) {
    ...
    catch (Exception e)
    {
      ...
      try {
        ...
        VbyP.errorLog("modifyGroup >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public BooleanAndDescriptionVO setCash(String account, String amount, String method, String reqname)
  {
    ...
    catch (Exception e)
    {
      ...
      try {
        ...
        VbyP.errorLog("setCash >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getAddressGroup()
  {
    ...
    try
    {
      ...
      VbyP.errorLogDaily("getAddressGroup >>" + e.toString()); } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getAddressGroup >> conn.close() Exception!");
      }conn = null;
    }
    return arr;
  }
    ...
    if (isLogin())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("getSentGroupList >> conn.close() Exception!");
        }conn = null;
      }
    }
  ...
  public List<SentVO> getSentList(int groupIndex, String line)
  {
    ...
    {
      label332: 
      try { if ((line.equals("mms")) || (line.equals("ktmms"))) {
        ...
        if ((user_id != null) && (!user_id.equals("")))
        {
          if ((user_id.equals("hhhyc")) && (line.equals("ktmms"))) {
            ...
            list = sf2.getSentListAdd(list2, connSMS, user_id, "mms", Integer.toString(groupIndex)); break label332;
          }
  ...
  public BooleanAndDescriptionVO cancelSent(int idx, String sendLine)
  {
    ...
    try
    {
      ...
      if ((sendLine.equals("mms")) || (sendLine.equals("ktmms")) || (sendLine.equals("ppmms"))) {
        ...
        connSMS = VbyP.getDB(sendLine);
        sf = SentLMSFactory.getInstance(); } else {
        connSMS = VbyP.getDB(sendLine);
      }
    ...
    catch (Exception e)
    {
      ...
      try {
        ...
        VbyP.errorLog("cancelSentGroupList >> conn.close() Exception!");
      }conn = null;
      connSMS = null;
    }
    return rvo;
  ...
  public String[] getHomeEmoti()
  {
    ...
    try
    {
      ...
      PreparedExecuteQueryManager pq = new PreparedExecuteQueryManager();
      pq.setPrepared(conn, buf.toString());
      arr = pq.ExecuteQuery(); } catch (Exception localException) {
    } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getHomeEmoti >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getEmotiCateList(String gubun)
  {
    ...
    try {
      ...
      arr = home.getMainCate(conn, gubun); } catch (Exception localException) {
    } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getEmotiCateList >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getEmotiForeignCateList(String gubun)
  {
    ...
    try {
      conn = VbyP.getDB();
      home = Home.getInstance();
      arr = home.getMainForeignCate(conn, gubun); } catch (Exception localException) {
    } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
        VbyP.errorLog("getEmotiForeignCateList >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getEmotiCateListLMS(String gubun)
  {
    ...
    try {
      conn = VbyP.getDB();
      home = Home.getInstance();
      arr = home.getLMSCate(conn, gubun); } catch (Exception localException) {
    } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
  ...
  public String[] getEmotiCateListMMS(String gubun)
  {
    ...
    try {
      conn = VbyP.getDB();
      home = Home.getInstance();
      arr = home.getMMSCate(conn, gubun); } catch (Exception localException) {
    } finally {
      try {
        if (conn != null) conn.close(); 
      } catch (SQLException e) {
  ...
  public ArrayList<HashMap<String, String>> getEmotiCatePage(String gubun, String category, int page, int count)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getEmotiCatePage >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<HashMap<String, String>> getEmotiCatePageLMS(String gubun, String category, int page, int count)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getEmotiCatePageLMS >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<HashMap<String, String>> getEmotiCatePageMMS(String gubun, String category, int page, int count)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getEmotiCatePageMMS >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getEmotiCate(String gubun, String category, int page)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getEmotiCate >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<HashMap<String, String>> getMymsg(int page)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getMymsg >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getHomeEmotiCate(String gubun, String category, int page)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getHomeEmotiCate >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getHomeMymsg(int page)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getHomeMymsg >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public String[] getEmoti(int page, String category)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getEmoti >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<NoticVO> getNotic()
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getNotic >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<NoticVO> getFaq()
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getFaq >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public ArrayList<NoticVO> getNoticMain(int cnt)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("getNoticMain >> conn.close() Exception!");
      }conn = null;
    }
  ...
  public int updateCntNotic(int idx)
  {
    ...
    try
    {
      ...
      try {
        ...
        VbyP.errorLog("updateCntNotic >> conn.close() Exception!");
      }
    }
    finally
    {
  ...
  public BooleanAndDescriptionVO addMymsg(String msg)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        VbyP.errorLog("addMymsg >> conn.close() Exception!");
      }
    }
    finally
    {
  ...
  public BooleanAndDescriptionVO delMymsg(int idx)
  {
    ...
    try
    {
      ...
      rvo.setstrDescription(e.getMessage());
	      try
	      {
	        ...
	        VbyP.errorLog("delMymsg >> conn.close() Exception!");
	      }
    }
    finally
    {
    ...
    return rvo; } 
  // ERROR //
  public String setCoupon(String key) { // Byte code:
		Connection conn = null;
		String resultString = "";
  ...
  public BooleanAndDescriptionVO setMMSUpload(byte[] bytes, String fileName) { VbyP.accessLog(" >> MMS 업로드 요청 ");
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("addEmotiCate >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("addEmotiForeignCate >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("addEmotiCateLMS >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("addEmotiCateMMS >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("moveEmotiCate >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("moveEmotiCateLMS >> conn.close() Exception!");
        }
      }
      finally
      {
    ...
    if (isAdminLogin().getbResult())
    {
      try
      {
        ...
        try {
          ...
          VbyP.errorLog("moveEmotiCateMMS >> conn.close() Exception!");
        }
      }
      finally
      {
